...
export function productGenerate(newDatasheet) {
  ...
  for (const product of newDatasheet) {
    const cardProduct = `<div id="card-product-${product.id}" class='card'>
                          <img id="imgProduct-${product.id}" class='imgProduct'src="./assets/img/${
                            product.nameFileImg1
                          }" 
                          alt="Produto ${
                            product.id
                          } da Magazine Hashtag" style="height:300px"/>
                          <p class='description text'>${product.name} - ${
      product.brand
    }</p>
                          <div>
                            <p class='price text'>$${product.price.toFixed(
                              2
                            )}</p>  <p class='priceBefore'>$${(
      product.price * 1.1
    ).toFixed(2)}</p>
                          </div>
                          <p class='text'>Em 10x de $${(
                            product.price / 10
                          ...
                          <div class="boxBtnBag">
                            <div class="divStar">
                              ...
                              <span class="star material-icons-round">star</span>
                              <span class="star material-icons-round">star</span>
                              <span class="star material-icons-round">star_half</span>
                            </div>
